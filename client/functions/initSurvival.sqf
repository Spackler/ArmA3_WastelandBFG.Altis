...
#define TIME_DELTA 10000 //seconds between each "check"
#define HEALTH_TIME (60*5) //seconds till death
#define HUNGER_TIME (10000*60) //seconds till starving
#define THIRST_TIME (10000*50) //seconds till dehydrated
